...
int_t	buildPset_WallCommon()
{
	...
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"Reference",(char*)"Reference",(char*)"",(char*)"IFCIDENTIFIER"));
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"AcousticRating",(char*)"AcousticRating",(char*)"",(char*)"IFCLABEL"));
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"FireRating",(char*)"FireRating",(char*)"",(char*)"IFCLABEL"));
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"Combustible",(char*)"Combustible", false));
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"SurfaceSpreadOfFlame",(char*)"SurfaceSpreadOfFlame",(char*)"",(char*)"IFCLABEL"));
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"ThermalTransmittance",(char*)"ThermalTransmittance", 0.24,(char*)"IFCTHERMALTRANSMITTANCEMEASURE"));
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"IsExternal",(char*)"IsExternal", true));
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"ExtendToStructure",(char*)"ExtendToStructure", false));
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"LoadBearing",(char*)"LoadBearing", false));
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"Compartmentation",(char*)"Compartmentation", false));
...
int_t	buildBaseQuantities_Wall(double width, double length, double height, double openingArea, double linearConversionFactor)
{
	...
	sdaiAppend(aggrQuantities, sdaiINSTANCE, (void*) buildQuantityLength((char*)"Width",(char*)"Width", width));
	sdaiAppend(aggrQuantities, sdaiINSTANCE, (void*) buildQuantityLength((char*)"Length",(char*)"Length", length));
	sdaiAppend(aggrQuantities, sdaiINSTANCE, (void*) buildQuantityArea((char*)"GrossFootprintArea",(char*)"GrossFootprintArea", (length / linearConversionFactor) * (width / linearConversionFactor)));
	sdaiAppend(aggrQuantities, sdaiINSTANCE, (void*) buildQuantityArea((char*)"NetFootprintArea",(char*)"NetFootprintArea", (length / linearConversionFactor) * (width / linearConversionFactor)));
	sdaiAppend(aggrQuantities, sdaiINSTANCE, (void*) buildQuantityArea((char*)"GrossSideArea",(char*)"GrossSideArea", grossSideArea));
	sdaiAppend(aggrQuantities, sdaiINSTANCE, (void*) buildQuantityArea((char*)"NetSideArea",(char*)"NetSideArea", netSideArea));
	sdaiAppend(aggrQuantities, sdaiINSTANCE, (void*) buildQuantityVolume((char*)"GrossVolume",(char*)"GrossVolume", grossSideArea * (width / linearConversionFactor)));
	sdaiAppend(aggrQuantities, sdaiINSTANCE, (void*) buildQuantityVolume((char*)"NetVolume",(char*)"NetVolume", netSideArea * (width / linearConversionFactor)));
	sdaiAppend(aggrQuantities, sdaiINSTANCE, (void*) buildQuantityLength((char*)"Height",(char*)"Height", height));
...
int_t	buildBaseQuantities_Opening(double depth, double height, double width)
{
	...
	sdaiAppend(aggrQuantities, sdaiINSTANCE, (void*) buildQuantityLength((char*)"Depth",(char*)"Depth", depth));
	sdaiAppend(aggrQuantities, sdaiINSTANCE, (void*) buildQuantityLength((char*)"Height",(char*)"Height", height));
	sdaiAppend(aggrQuantities, sdaiINSTANCE, (void*) buildQuantityLength((char*)"Width",(char*)"Width", width));
...
int_t	buildPset_WindowCommon()
{
	...
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"FireRating",(char*)"FireRating",(char*)"",(char*)"IFCLABEL"));
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"AcousticRating",(char*)"AcousticRating",(char*)"",(char*)"IFCLABEL"));
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"SecurityRating",(char*)"SecurityRating",(char*)"",(char*)"IFCLABEL"));
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"IsExternal",(char*)"IsExternal", true));
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"Infiltration",(char*)"Infiltration", 0.3,(char*)"IFCVOLUMETRICFLOWRATEMEASURE"));
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"ThermalTransmittance",(char*)"ThermalTransmittance", 0.24,(char*)"IFCTHERMALTRANSMITTANCEMEASURE"));
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"GlazingAreaFraction",(char*)"GlazingAreaFraction", 0.7,(char*)"IFCPOSITIVERATIOMEASURE"));
	sdaiAppend(aggrHasProperties, sdaiINSTANCE, (void*) buildPropertySingleValue((char*)"SmokeStop",(char*)"SmokeStop", false));
