...
int_t	buildSurfaceStyleInstance(MATERIAL3D * material)
{
	...
	sdaiAppend(aggrStyles, sdaiINSTANCE, (void*) buildSurfaceStyleRenderingInstance(material));
...
int_t	buildPresentationStyleAssignmentInstance(MATERIAL3D * material)
{
	...
	sdaiAppend(aggrStyles, sdaiINSTANCE, (void*) buildSurfaceStyleInstance(material));
...
int_t	buildStyledItemInstance(MATERIAL3D * material, int_t ifcRepresentationItemInstance)
{
	...
	sdaiAppend(aggrStyles, sdaiINSTANCE, (void*) buildPresentationStyleAssignmentInstance(material));
