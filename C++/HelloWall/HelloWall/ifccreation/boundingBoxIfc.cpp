...
void	createIfcBoundingBoxShape(double width, double thickness, double height, char * representationIdentifier)
{
	...
	sdaiAppend(aggrRepresentations, sdaiINSTANCE, (void*) buildShapeRepresentationInstance(BODY_BOUNDINGBOX_REPRESENTATION, width, thickness, height, representationIdentifier));
}
