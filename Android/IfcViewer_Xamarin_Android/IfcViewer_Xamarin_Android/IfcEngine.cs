...
namespace IfcEngine
{
    class x86_64
    {
        ...
        public static void engiGetAggrUnknownElement(long aggregate, long elementIndex, out long valueType, out long value)
        {
            if (_x86)
            {
                x86.engiGetAggrUnknownElement((int)aggregate, (int)elementIndex, out int iValueType, out int iValue);
                valueType = iValueType;
                value = iValue;
            }
            else
            {
                x64.engiGetAggrUnknownElement(aggregate, elementIndex, out valueType, out value);
            }
        }



        public static void engiGetAggrUnknownElement(long aggregate, long elementIndex, out long valueType, out double value)
        {
            if (_x86)
            {
                x86.engiGetAggrUnknownElement((int)aggregate, (int)elementIndex, out int iValueType, out value);
                valueType = iValueType;
            }
            else
            {
        ...
        public static void engiGetAggrUnknownElement(long aggregate, long elementIndex, out long valueType, out IntPtr value)
        {
            if (_x86)
            {
                x86.engiGetAggrUnknownElement((int)aggregate, (int)elementIndex, out int iValueType, out value);
        ...
        public static long sdaiErrorQuery()
        {
            if (_x86)
            {
                return x86.sdaiErrorQuery();
            }

            return x64.sdaiErrorQuery();
        }
