...
namespace IfcEngine
{
    class x64
    {
        ...
        //[DllImport(IFCEngineDLL, EntryPoint = "engiOpenModelByArray", CallingConvention = CallingConvention.Cdecl)]
        //public static extern Int64 engiOpenModelByArray(Int64 repository, byte[] ifcContent, Int64 length, string schemaName);
        ...
        [DllImport(IFCEngineDLL, EntryPoint = "GetSPFFHeaderItem", CharSet = CharSet.Auto)]
