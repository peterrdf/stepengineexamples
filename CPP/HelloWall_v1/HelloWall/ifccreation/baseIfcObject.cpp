...
int_t	buildRelDeclares_ProjectLibrary(int_t ifcProjectLibraryInstance)
{
	...
	if (aggr_ifcRelDeclaresInstance_RelatedDefinitions_ProjectLibrary == 0) {
		...
		sdaiAppend(aggr_ifcRelDeclaresInstance_RelatedDefinitions_ProjectLibrary, sdaiINSTANCE, (void*) ifcProjectInstance);
...
int_t	buildRelDeclares_WallType(int_t ifcWallTypeInstance)
{
	...
	if (ifcRelDeclaresInstance == 0) {
		...
		sdaiAppend(aggr_ifcRelDeclaresInstance_RelatedDefinitions, sdaiINSTANCE, (void*) ifcWallTypeInstance);
...
int_t	buildMaterialConstituentSet()
{
	...
	sdaiAppend(aggrMaterialConstituents, sdaiINSTANCE, (void*) buildMaterialConstituent((char*)"Glass"));
	sdaiAppend(aggrMaterialConstituents, sdaiINSTANCE, (void*) buildMaterialConstituent((char*)"Wood"));
