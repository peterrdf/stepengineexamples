...
BEGIN_MESSAGE_MAP(CIFCEditorApp, CWinAppEx)
...
CIFCEditorApp::CIFCEditorApp() noexcept
{
...
int CIFCEditorApp::ExitInstance()
{
...
// CIFCEditorApp customization load/save methods

void CIFCEditorApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
