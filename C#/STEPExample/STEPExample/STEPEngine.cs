...
namespace StepEngine
{
    class x86_64
    {
        ...
        public static extern Int64 engiOpenModelByStream(Int64 repository, [MarshalAs(UnmanagedType.FunctionPtr)] WriteCallBackFunction callback, string schemaName);

        [DllImport(STEPEngineDLL, EntryPoint = "engiOpenModelByStream")]
        public static extern Int64 engiOpenModelByStream(Int64 repository, [MarshalAs(UnmanagedType.FunctionPtr)] WriteCallBackFunction callback, byte[] schemaName);
