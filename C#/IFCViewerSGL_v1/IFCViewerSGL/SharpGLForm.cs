        ...
        private void InitDrawFaces()
        {
            ...
            while (myMaterial != null)
            {
                ...
                while (ifcItem != null) {
                    ...
                    while (myMaterials != null) {
                        if (myMaterials.material == myMaterial) {
                            for (int_t iIndex = 0; iIndex < myMaterials.__noPrimitivesForFaces * 3; iIndex++)
                            {
 ...
 //               gl.BindTexture(OpenGL.GL_TEXTURE_2D, 0);
	        ...
	        */
            ...
            foreach (var ifcItem in _ifcModel.Geometry)
            {
			    ...
			    */
                ...
                for (int_t iIndex = 0; iIndex < ifcItem._facesIndices.Length; iIndex++)
                {
                    gl.Vertex(
        ...
        private void DrawPointedFaces()
        {
            ...
            */
            ...
            for (int_t iIndex = 0; iIndex < _pointedItem._facesIndices.Length; iIndex++)
            {
                gl.Normal(
        ...
        private void DrawSelectedFaces()
        {
            ...
            */
            ...
            for (int_t iIndex = 0; iIndex < _selectedItem._facesIndices.Length; iIndex++)
            {
                gl.Normal(
