...
namespace IFCViewerSGL
{
    ...
    public class IFCModel
    {
        ...
        public IFCModel()
        {
            string strRootPath = Assembly.GetExecutingAssembly().Location.ToUpper().Replace("IFCVIEWERSGL.EXE", "");
        ...
        private bool ParseIFCFile(string strPath)
        {
            ...
            string strExpFile = Assembly.GetExecutingAssembly().Location.ToUpper().Replace("IFCVIEWERSGL.EXE", "");
